            ...
            for (let ii = 0; ii < this.game.currentLevel.map[i].length; ii++) {
                ...
                switch (this.game.currentLevel.map[i][ii]) {
                    ...
                    case 'R':
                        imgX = 0;
                        imgY = 2;
                        break; // R = Path + Right Boarder Grass
                    case 'B':
                        imgX = 0;
                        imgY = 5;
                        break; // B = Path + Right Boarder + Bottom Boarder Grass
                    case 'C':
                        imgX = 0;
                        imgY = 1;
                        break; // T = Path + Bottom Boarder Grass
                    case 'T':
                        imgX = 4;
                        imgY = 3;
                        break; // T = Path + Bottom Boarder Grass
                    case 'A':
                        imgX = 6;
                        imgY = 4;
                        break; // T = Grass + path bottom + path right
                    case 'L':
                        imgX = 0;
                        imgY = 3;
                        break; // L = Path + Left Boarder Grass
                    case 'P':
                        imgX = 4;
                        imgY = 0;
                        break; // P = Path + Left Boarder + top border Grass
                    case 'K':
                        imgX = 4;
                        imgY = 2;
                        break; // B = Path + bottom Grass
                    case 'I':
                        imgX = 4;
                        imgY = 4;
                        break; // B = Path + bottom Grass
                    ...
                    case 'S':
                        imgX = 4;
                        imgY = 6;
                        break; // S = Start of lvl
                    case 'E':
                        imgX = 5;
                        imgY = 6;
                        break; // E = End of lvl
                }
                this.ctx.drawImage(this.assets.images['env'], imgX * 32, imgY * 32, 32, 32, itemX, itemY, 32, 32);
            }
        }
        this.drawPlayer();
